...
FONT_SETTINGS = {
    ...
    "Kind Daily": (2, 0.069, 1, 1, 0.074, 0.04),
    ...
    "Square Game": (7, 0.069, 5, 1, 0.074, 0.03),
    "Super Greatly": (3, 0.069, 2, 1, 0.074, 0.03),
    "SuperMario256": (1, 0.069, 1, 1, 0.074, 0.03),
    "Supersonic Rocketship": (5, 0.069, 6, 1, 0.074, 0.03),
    "THEBOLDFONT": (4, 0.069, 3, 1, 0.074, 0.03),
}
...
# Get font settings or defaults
main_res, main_ext, border_res, border_bevel_res, border_ext, border_bevel_depth = \
    FONT_SETTINGS.get(font_key, (9, 0.04, 5, 4, 0.04, 0.024))
...
border_curve.bevel_resolution = border_bevel_res
border_curve.extrude = border_ext
border_curve.bevel_depth = border_bevel_depth if border_bevel_depth else 0.024
